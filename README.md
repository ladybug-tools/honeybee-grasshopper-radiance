[![Build Status](https://travis-ci.com/ladybug-tools/honeybee-grasshopper-radiance.svg?branch=master)](https://travis-ci.com/ladybug-tools/honeybee-grasshopper-radiance)
